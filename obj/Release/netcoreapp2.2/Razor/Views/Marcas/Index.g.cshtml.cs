#pragma checksum "C:\Users\juan_\source\repos\Prueba ABM\Prueba ABM\Views\Marcas\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "205137e89ca1470e9961096dfd9a3f8178394ae6"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"205137e89ca1470e9961096dfd9a3f8178394ae6", @"/Views/Marcas/Index.cshtml")]
...
<div id=""testVue"">
  <table class=""table"">
    ...
    <tr v-show=""editMode"">
      <td></td>
      <td><input v-model=""editMarca.nombre"" v-on:keyup.enter=""editarMarca(editMarca)"" /></td>
      <td>
        <button class=""btn btn-primary"" v-on:click=""editarMarca(editMarca)"">Guardar</button>
        <button class=""btn btn-secondary"" v-on:click=""toggleEditMarca()"">Cancelar</button>
      </td>
    </tr>
    <tr v-show=""!editMode"">
      <td></td>
    ...
    <tbody v-for=""marca in marcas"" v-show=""!editMode"">
      <tr>
        <td> {{");
            WriteLiteral(@" marca.id }} </td>
        <td> {{ marca.nombre }} </td>
        <td>
          <button class=""btn btn-outline-secondary"" v-on:click=""toggleEditMarca(marca)"">Editar</button>
          <button class=""btn btn-outline-primary"" v-on:click=""getMarca(marca.id)"">Detalles</button>
